...
function New-DesktopShortcut {
  ...
  New-Shortcut -Link $Link -Target $Target -SpecialFolder "CommonDesktop" -Icon $Icon -Description $Description
}
...
function New-StartupShortcut {
  ...
  New-Shortcut -Link $Link -Target $Target -SpecialFolder "CommonStartup" -Icon $Icon -Description $Description
}

function New-ProgramsShortcut {
  [CmdletBinding()]
  param(
    [string] $Link,
    [string] $Target,
  ...
  New-Shortcut -Link $Link -Target $Target -SpecialFolder "CommonPrograms" -Icon $Icon -Description $Description
}
